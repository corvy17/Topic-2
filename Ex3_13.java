...
public class Ex3_13 {
	...
	public static void main(String[] args) {
		...
		System.out.print("(0-single filter, 1-married jointly or " +
			...
			switch (status)
			{
				case 0 : tax += (income <= 8350) ? income * 0.10 : 8350 * 0.10;
							if (income > 8350)
				...
				case 1 : tax += (income <= 16700) ? income * 0.10 : 16700 * 0.10;
							if (income > 16700)
				...
				case 2 : tax += (income <= 8350) ? income * 0.10 : 8350 * 0.10;
							if (income > 8350)
								tax += (income <= 33950) ? (income - 8350) * 0.15 :
								(33950 - 8350) * 0.15;
							if (income > 33950)
				...
				case 3 : tax += (income <= 11950) ? income * 0.10 : 11950 * 0.10;
							if (income > 11950)
